...
CircularOrbitTraceExporter::Finalize()
{
    ...
    const Json manifest = {
        ...
        {"constellation",
         {{"name", m_config.constellation.constellationName},
          {"pattern", m_config.constellation.constellationPattern},
          {"num_orbits", m_config.constellation.numOrbits},
          {"satellites_per_orbit", m_config.constellation.satellitesPerOrbit},
          {"satellite_count", m_config.constellation.GetSatelliteCount()},
          {"altitude_m", static_cast<double>(m_config.constellation.altitudeM)},
          {"inclination_deg", static_cast<double>(m_config.constellation.inclinationDeg)},
          {"phase_diff", m_config.constellation.phaseDiff},
          {"orbit_epoch_offset_ns", m_config.constellation.orbitEpochOffsetNs}}},
        {"topology",
