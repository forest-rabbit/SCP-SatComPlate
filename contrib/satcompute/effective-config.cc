    ...
    Json root = {
        ...
        {"constellation",
         {{"source_path", config.constellation.sourcePath.string()},
          {"num_orbits", config.constellation.shell.planes},
          {"satellites_per_orbit", config.constellation.shell.sats},
          {"satellite_count", config.constellation.GetSatelliteCount()},
          {"altitude_km", config.constellation.shell.alt},
          {"inclination_deg", config.constellation.shell.inc},
          {"phasing_factor", config.constellation.shell.phasing},
          {"raan_span_deg", config.constellation.shell.raanSpanDeg}}},
        {"network",
