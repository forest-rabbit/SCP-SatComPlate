...
以下截图均来自已提交的原始 1000 秒场景配置，未修改星座或计算节点配置。
图片采用较小尺寸；点击可查看原图。

### 66 星 / 22 计算星

`detailed` 模式，各时刻均显示活动 ISL。

| 300 s | 600 s | 900 s |
| :---: | :---: | :---: |
| [![66 星在 300 秒的轨道可视化](docs/orbit-66-isl-300s.png)](docs/orbit-66-isl-300s.png) | [![66 星在 600 秒的轨道可视化](docs/orbit-66-isl-600s.png)](docs/orbit-66-isl-600s.png) | [![66 星在 900 秒的轨道可视化](docs/orbit-66-isl-900s.png)](docs/orbit-66-isl-900s.png) |

### 351 星 / 117 计算星

`simplified` 模式，为避免大规模链路遮挡卫星和经纬网而隐藏 ISL。

| 300 s | 600 s | 900 s |
| :---: | :---: | :---: |
| [![351 星在 300 秒的轨道可视化](docs/orbit-351-300s.png)](docs/orbit-351-300s.png) | [![351 星在 600 秒的轨道可视化](docs/orbit-351-600s.png)](docs/orbit-351-600s.png) | [![351 星在 900 秒的轨道可视化](docs/orbit-351-900s.png)](docs/orbit-351-900s.png) |
