...
本目录只维护当前 **66 星、801 任务、1300 秒** 场景；不再提供历史候选或 F3 victim 搜索。
...
原有 240 dense、240 sparse、240 compression、80 LLM 不变，另增任务 801（400 MB compression）。705 个普通图像使用
...
当前种子下 INPUT=193926895311 B、RESULT=100063510008 B、WU=352223833。
任务 801 沿用任务 120 的端点，提前 6.2 s 到达、计算 6 s；不消耗原 800 任务的生成随机流。
