...
./waf --run-no-build "satcompute \
  --topologyDir=contrib/satcompute/tests/fixtures/topology/snapshots/diamond-4-static \
  --computeProfile=contrib/satcompute/tests/fixtures/topology/compute-profiles/diamond-4-compute-profile.json \
  --taskTrace=contrib/satcompute/tests/fixtures/traffic/tasks/task-fcfs.json \
...
./waf --run-no-build "satcompute \
  ...
  --taskTrace=contrib/satcompute/tests/fixtures/traffic/tasks/stress-generated-40.json \
...
python3 contrib/satcompute/tools/validation/check-task-output.py run \
  ...
  --task-trace=contrib/satcompute/tests/fixtures/traffic/tasks/stress-generated-40.json \
  --workload-summary=contrib/satcompute/tests/fixtures/traffic/tasks/stress-generated-40-summary.json \
