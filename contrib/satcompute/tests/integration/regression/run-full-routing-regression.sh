...
run_platform() {
  ...
  shift
  ./ns3 run --no-build "satcompute --protectionScheme=off --faultMode=none --computeProfile=none --taskTrace=none --linkMetrics=0 --taskCompletionPolicy=strict --outputDir=$output_directory $*"
}
