#!/usr/bin/env python3
"""Offline partial coverage and hypothetical dependency-envelope audit; no simulation."""
import argparse
import json
...
if __name__=='__main__':
    ...
    api=runpy.run_path(str(Path(__file__).resolve().parents[2]/'support/protection/input_partial_predictability_audit.py'))
    ...
    print(json.dumps({k:result[k] for k in ('status','simulation_started','v4_features_identical','raw_evidence_read_only')},indent=2))
