...
./ns3 run --no-build "satcompute-n5c-placement-test"
./ns3 run --no-build "satcompute-frequency-runtime-test --outputDir=$test_output/frequency"
python3 contrib/satcompute/tests/integration/regression/analyze-n5c-placement.py --fixtures "$test_output/frequency"
