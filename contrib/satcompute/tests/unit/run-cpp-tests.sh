...
./ns3 run --no-build "satcompute-compfrr-placement-test"
./ns3 run --no-build "satcompute-frequency-runtime-test --outputDir=$test_output/frequency"
python3 contrib/satcompute/tests/integration/regression/analyze-compfrr-placement.py --fixtures "$test_output/frequency"
